...
const COMPANY_NAME = "Ladon";

// Sample blog data - replace with your actual data source
const seedPosts = [
  {
    id: 1,
    title: "Technical Manual Translation Services",
    excerpt: "Blog for approval",
    imageUrl: "/blog-one.png",
    date: "Apr 29",
    readTime: "N/A",
    url: "https://docs.google.com/document/d/1qcUrmZDoVZPM93uaeFbpDSl2oYtSEczQKWeAThqjSYk/edit?usp=sharing",
    status: "pending",
  },
  {
    id: 2,
    title: "How to Translate Corporate Training for Global Teams (Complete 2025 Guide)",
    excerpt: "Blog for approval",
    imageUrl: "/blog-two.png",
    date: "Apr 29",
    readTime: "N/A",
    url: "https://docs.google.com/document/d/1iLzj-lkNCfyQCLajBq25vwHoLNZm1kMgHbpxhoj2WgI/edit?usp=sharing",
    status: "pending",
  },
  {
    id: 3,
    title: "Translating Corporate Videos: Subtitles, Voice-Overs, and Best Practices for Global Engagement",
    excerpt: "Blog for approval",
    imageUrl: "/blog-three.png",
    date: "May 2",
    readTime: "N/A",
    url: "https://docs.google.com/document/d/1KKjwp1kIUNkBRWsSZ2zqEHfSm2VHwZb3gbi_w1M-5bk/edit?tab=t.0#heading=h.m00i03t1nutc",
    status: "pending",
  },
  {
    id: 4,
    title: "Certified Translation Services for Immigration & Refugees (2025 Guide)",
    excerpt: "Blog for approval",
    imageUrl: "/blog-four.png",
    date: "May 8",
    readTime: "N/A",
    url: "https://docs.google.com/document/d/1uRmBWCFDQdzrNnLwkmTPM11feQ_laFL1LS0--HQZoYQ/edit?tab=t.0#heading=h.4besy2d0wnx5",
    status: "pending",
  },
]
